...
namespace MascotaFeliz.App.Persistencia
{
    public class RepositorioDueno : IRepositorioDueno
    {
        ...
        /// </summary>
        private readonly AppContext _appContext; //atributo de la clase _appContext
        /// <summary>
        ...
        public RepositorioDueno(AppContext appContext) //método constructor el appContext es variable de BD
        {
        ...
        {
            var duenoAdicionado = _appContext.Duenos.Add(dueno); //poner los atributos de dueno en los campos de la tabla Duenos
